...
class AndTrigger(Trigger):
    ...
    def evaluate(self, story):
        return self.trigger1.evaluate(story) == True and self.trigger2.evaluate(story)
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, story):
        return self.trigger1.evaluate(story) == True or self.trigger2.evaluate(story)
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        if self.isWordIn(story.getTitle()) or self.isWordIn(story.getSummary()) or self.isWordIn(story.getSubject()):
            return True
        return False
...
def main_thread(master):
    ...
    try:
        ...
        t1 = TitleTrigger("USNMNT")
        t2 = SubjectTrigger("Klinsmann")
        t3 = PhraseTrigger("World Cup")
        t4 = OrTrigger(t2, t3)
        triggerlist = [t1, t4]
